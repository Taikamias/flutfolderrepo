...
*/
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(title: new Text("Bängeri äppi"), backgroundColor: Color.fromRGBO(85, 122, 149, 1)),
        drawer: new Drawer(
          child: new ListView(
            children: <Widget>[
        ...
        body: new Center(
          child: new Text("Etu_sivu", style: new TextStyle(fontSize: 35.0)),
        )
    );
  }
}